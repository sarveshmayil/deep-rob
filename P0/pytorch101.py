...
def mutate_tensor(
    ...
    #                     TODO: Implement this function                      #
    ##########################################################################
    assert len(indices) == len(values), 'indices and values should have same number of elements'

    for ii in range(len(indices)):
        x[indices[ii][0],indices[ii][1]] = values[ii]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return x
...
def multiples_of_ten(start: int, stop: int) -> Tensor:
    ...
    #                      TODO: Implement this function                     #
    ##########################################################################
    vals = torch.arange(start, stop+1)
    multiples = []
    for val in vals:
        if (val % 10 == 0):
...
def slice_assignment_practice(x: Tensor) -> Tensor:
    ...
    #                      TODO: Implement this function                     #
    ##########################################################################
    x[:2, :6] = torch.arange(6)
    x[:2, 3:6] = 2
    x[2:4, :6] = torch.arange(6) + 1
    x[2:4, 5] = 5
...
def reverse_rows(x: Tensor) -> Tensor:
    ...
    #                      TODO: Implement this function                     #
    ##########################################################################
    row_idxs = -1*(torch.arange(x.shape[0])+1)
    y = x[row_idxs]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
...
def take_one_elem_per_col(x: Tensor) -> Tensor:
    ...
    #                      TODO: Implement this function                     #
    ##########################################################################
    row_idxs = torch.tensor([1, 0, 3])
    col_idxs = torch.tensor([0, 1, 2])
    y = x[row_idxs, col_idxs]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return y
...
def make_one_hot(x: List[int]) -> Tensor:
    ...
    ##########################################################################
    C = max(x) + 1
    y = torch.zeros(len(x), C, dtype=torch.int64)
...
def sum_positive_entries(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    mask = (x > 0)
    pos_sum = torch.sum(x[mask]).to(torch.int64).item()
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return pos_sum
...
def normalize_columns(x: Tensor) -> Tensor:
    ...
    #                      TODO: Implement this function                     #
    ##########################################################################
    col_means = (1/x.shape[0]) * torch.sum(x, 0)
    col_stdvs = torch.sqrt( (1/(x.shape[0]-1)) * torch.sum((x-col_means)**2, 0))
    y = (x-col_means)/col_stdvs
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return y
